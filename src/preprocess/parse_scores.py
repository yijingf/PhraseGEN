...
if __name__ == "__main__":
    ...
    for composer in ['mozart', 'haydn', 'beethoven', 'scarlatti']:
        ...
        for krn_file in tqdm(krn_files):
            ...
            base_name = os.path.basename(krn_file).split(".")[0]
            mxml_file = os.path.join(mxml_dir, composer, f"{base_name}.xml")
            event_file = os.path.join(event_dir, composer, f"{base_name}.json")
